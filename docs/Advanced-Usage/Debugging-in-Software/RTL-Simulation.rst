...
conventional target-simulation. Specifically, the host-time between clocks edges
will will not be proportional to target-time elapsed over that interval, and
